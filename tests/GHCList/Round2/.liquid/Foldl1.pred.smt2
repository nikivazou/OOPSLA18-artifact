...
(push 1)
(assert (not (exists ((lq_karg$36$xs$35$$35$$34$$47$Users$47$niki$47$tmp$47$OOPLSA18$45$artifact$47$tests$47$GHCList$47$Round2$47$Foldl1.hs$34$$32$$40$line$32$12$44$$32$column$32$58$41$ Int) (len$32$xs Int)) (and (= len$32$xs 0)))))
(check-sat)
; SMT Says: Unsat
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (not (forall ((lq_karg$36$xs$35$$35$$34$$47$Users$47$niki$47$tmp$47$OOPLSA18$45$artifact$47$tests$47$GHCList$47$Round2$47$Foldl1.hs$34$$32$$40$line$32$12$44$$32$column$32$58$41$ Int)) (=> true true))))
(check-sat)
; SMT Says: Unsat
(pop 1)
(push 1)
(assert (not (forall ((lq_karg$36$xs$35$$35$$34$$47$Users$47$niki$47$tmp$47$OOPLSA18$45$artifact$47$tests$47$GHCList$47$Round2$47$Foldl1.hs$34$$32$$40$line$32$12$44$$32$column$32$58$41$ Int) (len$32$xs Int)) (=> (and (= len$32$xs 0)) true))))
(check-sat)
; SMT Says: Unsat
(pop 1)
(push 1)
